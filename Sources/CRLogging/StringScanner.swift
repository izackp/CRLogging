...
class StringScannerError: LocalizedError {
...
//NOTE: this converts between String.Index and Int a lot which is very inefficient
public struct StringScanner {
    ...
    public init(str: String, pos: Int, dir: Int) {
        self.span = str.substring(to: str.count)
        self.pos = pos
        self.dir = dir
    }
